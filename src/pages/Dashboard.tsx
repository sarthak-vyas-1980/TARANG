    ...
    <div className="min-h-screen py-8 px-2">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <Card padding="lg" shadow="sm" className="mb-0">
          ...
          {isOfficial && pendingCount > 0 && (
            <Card padding="md" shadow="sm" className="mt-4 bg-yellow-50 border-l-4 border-yellow-400">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, index) => {
          ...
          return (
            <Card key={index} padding="lg" shadow="sm">
              <div className="flex items-center justify-between">
                <div>
      ...
      <Card padding="lg" shadow="sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link
            to="/create-report"
            className="flex items-center p-4 hover:bg-red-100/40 transition-all shadow-md rounded-md"
          >
          ...
          <Link
            to="/map"
            className="flex items-center p-4 hover:bg-blue-100/40 transition-all shadow-md rounded-md"
          >
          ...
          {isOfficial ? (
            <Link
              to="/reports"
              className="flex items-center p-4 hover:bg-green-100/40 transition-all shadow-md rounded-md"
            >
            ...
            <Link
              to="/reports"
              className="flex items-center p-4 hover:bg-gray-100/40 transition-all shadow-md rounded-md"
            >
